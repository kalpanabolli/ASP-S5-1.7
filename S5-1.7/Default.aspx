<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="S5_1._7.Default" %>
                     ...
                     <div class="row mt-5">
                        ...
                        <div class="col-8">
                            <asp:ImageButton ID="ImageButton1" runat="server"  Height="40"
                                ImageUrl="~//Image//P1img.jpeg" ImageAlign="Left" OnClick="ImageButton1_Click" />
        ...
        <div class="col-6">
                 <div class="row mt-5">
                        ...
                        <div class="col-7">
                            ...
                            <asp:Image runat="server" Height="300" Width="300" id="imgUpload" ImageUrl="~//Image//P1img.jpeg"/>
                        </div>
